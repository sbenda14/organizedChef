 ...
 ?>
	<div class="content plainText" id="home">
		...
		<p> 
			...
			Get started today by <a href="/pages/login/register.php">joining</a> or <a href="/pages/login/login.php">signing in</a>!
		</p>
		...
		<div id="signUp" class="plainText">
				Interested? <a href="/pages/login/register.php">Join</a> today!
		</div>
	</div>
