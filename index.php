 ...
 ?>
		<div class="content">
			<div class="plainText" id="home">
				...
				Get started today by <a href="register.php">joining</a> or <a href="login.php">signing in</a>!
				</p>
			</div>
			<div class="display">
				<div id="screenshot1" class="screenshot">screenshot coming soon </div>
				<div id="screenshot2" class="screenshot">screenshot coming soon </div>
				<div id="screenshot3" class="screenshot">screenshot coming soon </div>
			</div>
