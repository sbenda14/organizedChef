<?php 
  session_start();
  include_once("src/components/banner.php");
  if(!isset($_SESSION['auth']) || !$_SESSION['auth']){
    include_once("src/components/joinUs.php");
  }else	{
	include_once("src/components/leaveUs.php");
   }
 ...
 ?>
	<div class="content plainText" id="home">
		...
		<p> 
			...
			Get started today by <a href="src/login/register.php">joining</a> or <a href="src/login/login.php">signing in</a>!
		</p>
		...
		<div id="signUp" class="plainText">
				Interested? <a href="src/login/register.php">Join</a> today!
		</div>
	</div>
